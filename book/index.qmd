...
Note that not all proposed functionality currently exists in these tools. Please see the [Roadmap](roadmap.qmd) for details.
...
3. [Detect bad channels](pipeline-steps.qmd#detect-bad-channels)
4. [Artifact detection](pipeline-steps.qmd#artifact-detection)
5. [Artifact curation](pipeline-steps.qmd#artifact-curation)
6. [Preprocessing](pipeline-steps.qmd#preprocessing)
7. [Spike sorting](pipeline-steps.qmd#spike-sorting)
8. [Postprocessing](pipeline-steps.qmd#postprocessing)
9. [Curation](pipeline-steps.qmd#curation)
